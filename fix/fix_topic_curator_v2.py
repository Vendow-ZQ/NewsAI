# Fix topic_curator.py to use batch analysis
with open('core/agents/topic_curator.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Replace _invoke_llm with batch version
old_invoke = '''    def _invoke_llm(self, context: dict, upstream_data: dict, tool_results: dict) -> dict:
